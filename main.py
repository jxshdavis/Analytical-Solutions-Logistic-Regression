...
for num_reg in [2, 4, 6, 8, 10]:
    sim = ExperimentSimulations.ExperimentSimulations(num_trials=40, num_regressors=num_reg, num_levels=2, num_obs=10**3, log_min_x=min_x,
...
#                                                           num_cols=2,
#                                                           data_pathname='/Users/joshdavis/Desktop/STAT RESEARCH/Analytical-Solutions-Logistic-Regression/datsets/cancer-data.csv',
...
# df = pd.read_csv(
#     '/Users/joshdavis/Desktop/Meng Research/Analytical-Solutions-Logistic-Regression/datsets/cancer-data.csv')
# y = df['diagnosis']
